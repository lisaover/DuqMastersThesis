...
//declare array to store 2014 score, 2014 upper and lower PI, 2013 score, upper and lower PI, school, district, mean, and median
var schoolInfo = [];
...
var actualProbWord13;
var actualProbWord14;
...
function init() {
	...
	*/
	...
	for (var i = 0; i < arrayBtns.length; i++) //iterate through array of 'li' tags
				{
...
function addBtnCSS(id) {
      ...
      sheet.innerHTML = "header a:hover, body#" + id + "_bdy #" + id + "_btn {color:rgb(27, 75, 64); background:rgb(255, 255, 255); box-shadow:3px 3px 5px rgba(119, 209, 190, 0.5) inset;}";
...
function processAndDisplay(evt) {
	...
	*/
		...
		schoolInfo = tempInfo;
   		...
   		//set style properties for selected school to display as active link in 'dashboard'
   		setActive(currentId);
                //set style properties for previous link to display as visited in 'dashboard' 
                if (prevId.length >= 1) {
                    setVisited(prevId[prevId.length-1]);
                }
		...
		actualProbWord13 = interpretProb(schoolInfo[score2013]);
		actualProbWord14 = interpretProb(schoolInfo[score2014]);
...
function writeDescriptive() {
   ...
   "<p class=\"center\"><a href=\"images/2013ScoreDistribution.jpg\" onclick=\"window.open (this.href, 'child', 'height=412,width=750,top=100,left=100'); return false\"><img src=\"images/2013ScoreDistribution.jpg\" width=\"325\" height=\"206\"/></a><BR><BR>Click the image to display a larger version in a new window.</p></div></div>";   	
   ...
   "<p class=\"center\"><a href=\"images/scaledMeanDistribution.jpg\" onclick=\"window.open (this.href, 'child', 'height=410,width=750,top=100,left=100'); return false\"><img src=\"images/scaledMeanDistribution.jpg\" width=\"325\" height=\"205\"/></a><BR><BR>Click the image to display a larger version in a new window.</p></div></div>";   	
   ...
   "<p class=\"center\"><a href=\"images/scaledMedianDistribution.jpg\" onclick=\"window.open (this.href, 'child', 'height=402,width=750,top=100,left=100'); return false\"><img src=\"images/scaledMedianDistribution.jpg\" width=\"325\" height=\"201\"/></a><BR><BR>Click the image to display a larger version in a new window.</p></div></div>";   	
...
*/
	function showSchool() {
   	...
   	*/
   	...
   	"<p><span class=\"highlight2\">Actual Score 2012-2013: </span>" + schoolInfo[score2013] + " (" + actualProbWord13 + ")</p>" +
   		"<p><span class=\"highlight2\">Actual Score 2013-2014: </span>" + schoolInfo[score2014] +  " (" + actualProbWord14 + ")</p>" +
   	separator + "<p class=\"highlight2\">Linear Regression from 2012-2013 Scores</p>" + 
   	"<p><a id=\"predict-score13\"  class=\"content-link\" href=\"\">Score from Model</a></p>" +
   	"<p><a id=\"predict-13\"  class=\"content-link\" href=\"\">95% Prediction Interval</a></p>" +
   		"<!-- <p><a id=\"conf-13\"  class=\"content-link\" href=\"\">95% Confidence Interval</a></p>-->" +
   	"<p class=\"highlight2\">Logistic Regression from 2012-2013 Scores</p>" + 
   ...
   //	var infoTitle = "<h3><a id=\"school-main\" class=\"title-link\" href=\"\">Income and School Performance <BR>Profile Score for</a><BR><BR><span class=\"highlight2\">" + schoolInfo[school] + "</span></h3>";
	...
	/**
   	...
   	*/
	var predictedScoreModel2013 = "<div class=\"content-box\" id=\"predict-score13_content\"><h3 class=\"title\">School Score from Model 2012-2013</h3>" + 
	"<div class=\"content\"><p>Model Score: <span class=\"color3\">" + predictedScore13 + "</span></p>" +
	"<p>The predicted score for a school with mean income, <span class=\"color1\">$" + formatIncome(schoolInfo[mean]) + 
	"</span>, and median income, <span class=\"color2\">$" + formatIncome(schoolInfo[median]) + "</span>, is <span class=\"color3\">" + predictedScore13 + "</span>.</p>" +
	"<a id=\"score13-math-link\" class=\"math-link\" href=\"\"><p class=\"center\">Show the Math</p></a><div id=\"score13-math\" class=\"math\">" +   
   "<p>For this school, the score <span class=\"color3\">" + predictedScore13  + "</span> = </p>" + 
   ...
   var prediction2013 = "<div class=\"content-box\" id=\"predict-13_content\"><h3 class=\"title\">95% Prediction Interval 2012-2013</h3>" + 
   "<div class=\"content\"><p>95% Prediction Interval: (<span class=\"color3\">" + schoolInfo[lowerPI2013] + "</span>, <span class=\"color3\">" + schoolInfo[upperPI2013] + "</span>)</p>" + 
   "<p>We can predict with 95% certainty that the interval (<span class=\"color3\">" + schoolInfo[lowerPI2013] + "</span>, <span class=\"color3\">" + schoolInfo[upperPI2013] + 
   "</span>) will contain the <span class=\"color4\">true</span> 2012-2013 School Performance Profile score for a school with mean income <span class=\"color1\">$" + formatIncome(schoolInfo[mean]) + 
        "</span> and median income <span class=\"color2\">$" + formatIncome(schoolInfo[median]) + "</span>.</p></div></div>";
    /*
    var confidence2013 = "<div class=\"content-box\" id=\"conf-13_content\"><h3 class=\"title\">95% Confidence Interval</h3>" +
	"<div class=\"content\"><p>95% Confidence Interval: (<span class=\"color3\">" + schoolInfo[lowerCI2013] + "</span>, <span class=\"color3\">" + schoolInfo[upperCI2013] + "</span>)</p>" +
	"<p>We are 95% confident that the interval (<span class=\"color3\">" + schoolInfo[lowerCI2013] + "</span>, <span class=\"color3\">" + schoolInfo[upperCI2013] + "</span>)" + 
	" contains the <span class=\"color4\">mean</span> School Performance Profile score for schools with mean income <span class=\"color1\">$" + formatIncome(schoolInfo[mean]) + 
        "</span> and median income <span class=\"color2\">$" + formatIncome(schoolInfo[median]) + "</span>.</p></div></div>";
        */
    var predictedScoreModel2014 = "<div class=\"content-box\" id=\"predict-score14_content\"><h3 class=\"title\">School Score from Model 2013-2014</h3>" + 
	"<div class=\"content\"><p>Model Score: <span class=\"color3\">" + predictedScore13 + "</span></p>" +
	"<p>The predicted score for a school with mean income, <span class=\"color1\">$" + formatIncome(schoolInfo[mean]) + 
	"</span>, and median income, <span class=\"color2\">$" + formatIncome(schoolInfo[median]) + "</span>, is <span class=\"color3\">" + predictedScore13 + "</span>.</p>" +
	"<a id=\"score14-math-link\" class=\"math-link\" href=\"\"><p class=\"center\">Show the Math</p></a><div id=\"score14-math\" class=\"math\">" +   
   "<p>For this school, the score <span class=\"color3\">" + predictedScore13  + "</span> = </p>" + 
   "<p class=\"center\">" + interceptReg + " + " + meanSlopeReg + "(<span class=\"color1\">" +  schoolInfo[mean]/scaleFactor + "</span>) + " + medianSlopeReg + "(<span class=\"color2\">" +  
     schoolInfo[median]/scaleFactor + ")</span> + <BR>(" + interactSlopeReg + ")(<span class=\"color1\">" + schoolInfo[mean]/scaleFactor + "</span> - " + meanGrandMean/scaleFactor + ")(<span class=\"color2\">" +  
     schoolInfo[median]/scaleFactor + "</span>  - " + medianGrandMean/scaleFactor + ")</p></div></div></div>";
  ...
  var predictedProbModel = "<div class=\"content-box\" id=\"predict-prob_content\"><h3 class=\"title\">Probability of Passing from Model</h3>" +
	...
	lnOdds + ")</span>)</sup>]</p></div></div>"; 	
   	...
   	var schContent = predictedScoreModel2013 + prediction2013 + predictedProbModel;
...
/**
	setActive() function formats the active dashboard links
*/
function setActive() {

	var link = document.getElementById(currentId);
	link.style.color = "rgb(27, 75, 64)";
	link.style.background = "rgb(215, 255, 255)";
        link.style.boxShadow = "1px 1px 5px rgba(0,60,119,0.5) inset";
...
function setVisited() {
	...
	var link = document.getElementById(prevId[prevId.length-1]);
	link.style.color = "rgb(79, 125, 107)";
	link.style.background = "rgb(119, 209, 190)";
        link.style.boxShadow = "1px 1px 5px rgba(0,60,119,0.5) inset";
	...
	link.addEventListener("mouseover",hoverLink,false);
        link.addEventListener("mouseout",resetVisitedLink,false);
...
function refreshLink(id) {
	...
	link.style.color = "rgb(27, 75, 64)";
	link.style.background = "rgba(0, 178, 169, 1)";
        link.style.boxShadow = "3px 3px 5px rgba(215,255,255,0.5) inset";
...
/**
	resetLink() is called on mouseout to style the dashboard links visited since page refresh
...
function resetLink(evt) {
	...
	var id = evt.currentTarget.getAttribute("id");
		...
		var link = document.getElementById(id);
		link.style.color = "rgb(27, 75, 64)";
	        link.style.background = "rgba(56, 148, 128, 1)";
                link.style.boxShadow = "3px 3px 5px rgba(215,255,255,0.5) inset";

} //end resetLink()

/**
	resetVisitedLink() is called on mouseout to style the dashboard links visited since page refresh
	because the refresh button breaks the css stylesheet 'a' styling
*/
function resetVisitedLink(evt) {
...
function hoverLink(evt) {
	...
	var link = document.getElementById(id);
	link.style.color = "rgb(0, 178, 169)";
	link.style.background = "rgb(38, 82, 66)";
